...
namespace DataHeater
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbSrcType.Items.AddRange(new object[] { "SQLite", "CSV", "Excel", "MariaDB", "PostgreSQL", "Oracle" });
            ...
            cmbTgtType.Items.AddRange(new object[] { "SQLite", "CSV", "Excel", "MariaDB", "PostgreSQL", "Oracle" });
            cmbTgtType.SelectedIndex = 3;
            ...
            lblStatus.Location = new Point(606, 560);
